        ...
        <div class="row">
            ...
            <h1><span class="badge badge-pill badge-dark"><h1>Registrar reservacion</h1></span></h1>
                <form method="post" action="guardarRegistro.php">
                    ...
                    <h1><span class="badge badge-pill badge-dark">Nombre</span></h1>
                        <input value="<?php echo $registro["nombre"]; ?>" type="text" class="form-control" name="nombre" placeholder="Teclea el nombre">
                    </div>

                    <div class="form-group">
                    <h1><span class="badge badge-pill badge-dark">Edad</span></h1>
                        <input value="<?php echo $registro["edad"]; ?>" type="number" class="form-control" name="edad" placeholder="Teclea la edad">
                    </div>
                     

                   
                    <h1><span class="badge badge-pill badge-dark">Sexo</span></h1>
                    <div class="form-group">
                    <?php
                        if($registro["sexo"]){
                            echo "<input type='radio' name='sexo' value='1' checked>  <b> Masculino</b><br>";
                            echo "<input type='radio' name='sexo' value='0'>    <b>Femenino </b><br>"; 
                        } else {
                            echo "<input type='radio' name='sexo' value='1'>   <b>Masculino</b><br>"; 
                            echo "<input type='radio' name='sexo' value='0' checked> <b> Femenino</b><br>"; 
                        }
                    ?>
                    </div>

                    <div class="form-group">
                    <h1><span class="badge badge-pill badge-dark">Domicilio</span></h1>
                        <textarea name="domicilio" id="" cols="30" rows="10" class="form-control"><?php echo $registro["domicilio"] ?>
                        </textarea>
                    </div>

                    <div class="form-group">
                    <h1><span class="badge badge-pill badge-dark">Fecha de nacimineto</span></h1>
